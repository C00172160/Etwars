...
private:
	...
	sf::Sprite captain1HealthSprite, captain2HealthSprite;
	bool buttonpressed;
	//TURNS
	...
	float Power = minPower;//PARTICLES
	...
	sf::Text player1health, player2health;
	...
	////////////////////////////////////////////////////////////////////////////////////
	bool changeState, shotgunFired, playerBuildCamera,tie;
	//AUDIO
	...
	bool placeable = true;
	sf::RectangleShape placingspriterectangle;
	...
	Water water1, water2, water3,water4,water5,water6,water7,water8,water9;
	vector<Block> blocks;
	int currentType;

	
	sf::Vector2f Explosionsource = sf::Vector2f(0, 0);
	sf::Sprite ExplosionSprite ,topSprite,topSprite2,topSprite3;
	sf::Texture dirttex, topStraighttex, leftStraighttex, topLeftCornertex,top ,topRightCornertex, bottomRightCornertex, rightStraight, bottomStraight, bottomLeftCorner, cameraposition, backGroundTexture, Explosion, steelblock, concreteblock;
